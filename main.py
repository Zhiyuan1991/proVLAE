...
def disentangle_check(sess, model, manager, test_img_ind, flags, save_original=False, step=0,):
  '''
    input:
      sess: TF session
    ...
    output:
      ...
      4.images generated by randomly sample latent variables from layer step,
      while fixing latent variables from other layers, in the checkpoint folder.
